...
<el-dialog title="编辑分组" :visible.sync="dialogFormVisible">
  <el-form :model="form">
    ...
    <el-form-item label="组内组织用户是否可重复添加" :label-width="formLabelWidth">
      <el-input v-model="form.name" autocomplete="off"></el-input>
    </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      organizationGroupList: async function () {
        let obj = await requestApi.getRequest('/api/organization/organizationGroupList', this)
